            ...
            <Collapse className="d-sm-inline-flex flex-sm-row-reverse" isOpen={!this.state.collapsed} navbar>
              <ul className="navbar-nav flex-grow">
                {!this.props.appState.isLoggedIn &&
                  <NavItem>
                    <Button className="text-dark" color="link" onClick={this.props.appState.auth.login}>Login</Button>
                  </NavItem>
                }
                {this.props.appState.isLoggedIn &&
                  <NavItem>
                    <NavLink tag={Link} className="text-dark" to="" onClick={this.props.appState.auth.logout}>Logout</NavLink>
                  </NavItem>
                }
                <NavItem>
